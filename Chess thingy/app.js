...
function dragDrop(e) {
    ...
    const spaceIsTaken = e.target.classList.contains('piece')
    ...
    if(correctGo){
        ...
        //then check this
        if(spaceIsTaken && !takenByOpponent){
            infoDisplay.textContent = "u cant go here"
            setTimeout(() => infoDisplay.textContent = "u cant go here", 2000)
            return
        }
        if(valid){
